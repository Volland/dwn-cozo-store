...
export class MessageStoreCozo implements MessageStore {
    ...
    put(tenant: string, message: GenericMessage, indexes: { [key: string]: string | boolean; }, options?: MessageStoreOptions | undefined): Promise<void> {
    ...
    get(tenant: string, cid: string, options?: MessageStoreOptions | undefined): Promise<GenericMessage | undefined> {
        options?.signal?.throwIfAborted();
